...
function buildRecipeCard(rTitle, rLink, rImg, rTime, rYield, rID) {
    recipeCardListEl.append('<li><div class="card-panel offWhite"><div class="row valign-wrapper"><div class="col s4"><img src="'+rImg+'" alt="recipe" class="circle responsive-img"></div><div class="col s8"><span class="black-text"><h4>'+rTitle+'</h4><div>Cooking Time: '+rTime+'</div><div>Feeds: '+rYield+'</div></span></div></div><div class="card-action"><div class="col s4"><a class="btn waves-effect waves-light left-align" href="'+rLink+'">Source</a></div><div class="col s4"><a class="btn waves-effect waves-light center-align saveBtn" id="'+ rID +'" href="#" data-title="'+rTitle+'" data-url="'+rLink+'" data-img="'+rImg+'" data-time="'+rTime+'" data-yield="'+rYield+'" data-id="'+rID+'" >Save</a></div><div class="col s4"><a class="btn waves-effect waves-light right-align" href="./recipe-breakdown.html?='+ rID +'">Cook!</a></div></div></div></li>');
  }
